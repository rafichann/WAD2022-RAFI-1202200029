...
if (!isset($_POST["daftar"])) {
    ...
    $no_hp = $_POST["no"];
    $result = mysqli_query($connector, "SELECT email FROM user_rafi WHERE email = '$email'");

    if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
        $password = password_hash($password, PASSWORD_DEFAULT);
        mysqli_query($connector, "INSERT INTO user_rafi VALUES ('', '$nama', '$email', '$password', '$no_hp')");
        ...
        echo "<meta http-equiv='refresh' content='2 url=Login-Rafi.php'>";
                    ...
                    <div class="form-login m-auto ps-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <span class="required" style="top: 0px; left: 41px;">*</span>
                                <input type="nama" id="nama" class="form-control form-control-lg" name="nama" required />
                            </div>
                            <!-- no hp input -->
                            <div class="form-outline mb-4">
                                <label class="form-label" for="no">No Hp</label>
                                <span class="required" style="top: 0px; left: 41px;">*</span>
                                <input type="no" id="no" class="form-control form-control-lg" name="no" required />
                            </div>
                            <!-- Password input -->
                            <div class="form-outline mb-4">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div class="text-center text-lg-start mt-4 pt-2">
                                    ...
                                    <p class="small fw-bold mt-2 pt-1 mb-0">Anda sudah punya akun? <a href="Login-Rafi.php" class="link-primary">Login</a></p>
                                </div>
                        </form>
                    </div>
                </div>
