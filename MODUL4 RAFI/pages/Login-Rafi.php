...
if (isset($_COOKIE["email"]) && isset($_COOKIE["password"])) {
    ...
    $result = mysqli_query($connector, "SELECT * FROM user_rafi WHERE email = '$email'");
                    ...
                    <div class="form-login m-auto ps-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="email" id="email" class="form-control form-control-lg" name="email" value="<?= isset($_COOKIE["email"]) ? $_COOKIE["email"] : ""; ?>" />
                            </div>
                            <!-- Password input -->
                            <div class="form-outline mb-3">
                                <label class="form-label" for="password">Password</label>
                                <input type="password" id="password" class="form-control form-control-lg" name="password" value="<?= isset($_COOKIE["password"]) ? $_COOKIE["password"] : ""; ?>" />
                            </div>
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class="small fw-bold mt-2 pt-1 mb-0">Anda belum punya akun? <a href="Register-Rafi.php" class="link-primary">Daftar</a></p>
                            </div>
                        </form>
                    </div>
